...
public class Opt {
    ...
    public String showItem(String type)
    {
        ...
        {
            opt+="<ul><li><a href='MovieDisplay?Action=MovieDisplay'>Movie</a></li><li><a href=''>Booking Records</a></li><li><a href=''>Loyalty Point</a></li><li><a href='CartRetrieve?action=personalInfo'>Personal Information</a></li><li><a href='CartRetrieve?action=shoppingCart'>Shopping Cart</a></li><li><a href='logoffControl'>Log off</a></li></ul>";
        }
